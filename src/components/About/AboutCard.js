    ...
    <Card className="quote-card-view">
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          <footer className="blockquote-footer">Integration test helps to identify any issue for end-to-end calls
          while unit test gives a quicker response as it’s able to identify the issue within a specific function. </footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
